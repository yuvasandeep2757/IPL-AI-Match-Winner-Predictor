...
### Backend Setup
1. Clone this repository: `git clone https://github.com/yuvasandeep2757/IPL-AI-Match-Winner-Predictor.git`
2. Navigate to the main directory.
3. Install the required Python packages: `pip install -r requirements.txt`
4. Run the Flask backend: `python app.py` (Runs on port 5000)
